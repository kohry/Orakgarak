...
public class Multiple {
	...
	public String toString() {
		return "Multiple [stockCode=" + stockCode + ", industryCode="
				+ industryCode + ", stockName=" + stockName + ", industryName="
				+ industryName + ", debt=" + debt + ", cash=" + cash
				+ ", netDebt=" + netDebt + ", marketValue=" + marketValue
				+ ", ev=" + ev + ", ebitda=" + ebitda + ", multipleResult="
				+ multipleResult + ", multipleDesc=" + multipleDesc
				+ ", score=" + score + "]";
	}
