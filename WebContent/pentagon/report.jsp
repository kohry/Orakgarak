...
$(document).ready(function() {	
	...
	;
		...
		$(".icon_news").on("click",function() {
			...
			console.log($(".ui.modal.news").modal('can fit'));
	...
	//이부분 모달띄우는 거임
	$(".icon_pay.logged").click(function() {
...
<div id="registBtnWrapper" class="icon_pay logged">
<a id="registBtn"><i class="won icon"></i>투자</a>
</div>
</c:when>
<c:otherwise>
<div id="registBtnWrapper" class="icon_pay notlogged ui" title="로그인이 필요한 기능입니다.">
<a id="registBtn_notlogged"><i class="won icon"></i>투자</a>
</div>
</c:otherwise>
</c:choose>
...
<div id="reportLower">
			...
			<div class="tabMenu">
				<nav class="cl-effect-13" id="cl-effect-13">
					...
					<a id="btnFS" onmouseover="" style="cursor: pointer; font-size:0.94em; font-weight:700;">재무제표 기타</a>
