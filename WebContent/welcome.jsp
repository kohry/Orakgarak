			...
			<table id="ourpicture" style="width:980px;padding:20px;">
				<tr>
				 ...
				 <tr>
					...
					<span class="memberrole">DEVELOPER</span>
					</td>
					<td>
					<span class="membername">최현진</span><br/>
					<span class="memberrole">DEVELOPER</span></td>
					<td>
				...
				<tr>
					...
					<span class="memberstory">&nbsp;&nbsp;정민철은 유학파임에도 불구하고 그의 첫인상은 청학동 출신입니다. 자유의 상징 미국에서 8년이나 살았지만 그 누구보다 가부장적입니다. 그는 한식매니아이며 가장 좋아하는 음식은 김치찌게 입니다. 그리고 노량진에서 횟값을 깎는 재주를 가지고 있습니다. 어디에서도 유학파의 흔적을 찾을 수 없어 학벌위조 논란이 있었지만 피자집에서 한국인은 아무도 시키지 않는 하와이안딜라이트를 시키는 것을 통해 유학파임을 짐작해볼 수 있습니다. 아무튼 그는 금융을 사랑해서 이 프로젝트가 시작되었습니다.</span></span>
					</td>
					<td style="text-align: left; vertical-align: top;">
					<span class="memberstory">&nbsp;&nbsp;최현진은 서강대에서 경영학을 전공했으며 적응력이 뛰어난 장점을 가지고 있습니다. 남자 셋뿐인 팀에 들어와 엄청난 적응력으로 그들을 모두 자신의 기쁨조로 만들어버리더니 스페인여행을 계획중인 지금은 시에스타에 적응하기 위해 점심을 먹고나면 낮잠을 즐기고 있습니다. 그리고 그녀는 막걸리 애주가로 술에 취하면 주변사람을 때리는 버릇이 있습니다. 그래서 회식자리에서 그녀의 옆자리는 늘 비어있다는 후문입니다. 아무튼 그녀는 오락가락에서 코딩과 디자인을 맡아서 방향잃은 코드에 영혼을 불어넣었습니다.</span></span>
					</td>
					<td style="text-align: left; vertical-align: top;">
					<span class="memberstory">&nbsp;&nbsp;고락윤은 서울대학교 경영학과에 출신으로 기계덕후의 기질을 버리지 못하고 IT업계로 흘러들어왔습니다. 남다른 그의 아방가르드한 패션감각과 깔매치 능력을 범인(凡人)은 미처 따라가지 못해 시대를 잘못타고 났다는 평이 있습니다. 또한, 투철한 실험정신으로 맥콜과 요거트를 섞어 먹는 신메뉴를 개발해 주변인들에게 전파하고 있는 선구자이기도 합니다. 프로그래밍 능력도 타의 추종을 불허하는 그는 현재 블루불스에서 섹시한 알고리즘 개발을 맡고 있습니다.</span></span>
					</td>
					<td style="text-align: left; vertical-align: top;">
					<span class="memberstory">&nbsp;&nbsp;차승환은 공대로 유명한 인하대에서 정치외교학을 전공했습니다. 그는 한 번 본 것을 까먹지 않고 기억하는 능력을 가지고 있습니다. 그는 정민철의 계좌번호까지 빠짐없이 외우는데 쓰잘데기 없다는 평도 많이 받습니다. 차승환 천재설이 제기되고 있지만 신은 그에게 올라프의 얼굴을 주었습니다. 그의 코드는 창의적으며 예측불허입니다. 아무도 상상하지 못한 방법으로 문제를 해결해내는 그는 현재 블루불스에서 야매 디버깅 전문가로 활동중입니다.</span></span>
					</td>
				</tr> 
