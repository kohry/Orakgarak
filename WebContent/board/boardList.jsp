...
<script type="text/javascript">
	$(document).ready(function(){		
		...
		/*  $("#gong2").each(function(index, value){
			...
			/* var repCount = ${replyCount }; 
			  
			  for (var i=1; i<repCount.length; i++) { 
				  $("#repCounter").text(repCount[i]);
				  alert(repCount[i]);
			      }   */
			  
		 /* 
		 alert(repCount); */
		//$("#replyCount").text(repCount);
   ...
   <tbody>
	...
	<tr>
      ...
      <td style="text-align: left; padding-left: 20px; background-color: #FFF;">
      	<a style="font-weight: bold;" id="title" href="${pageContext.request.contextPath }/board_detail.do?boardNo=${list.boardNo}">${list.boardTitle }[${replyCount[0]}]</a>
    ...
    <tr>
      ...
      <td style="text-align: left; padding-left: 20px"><a id="title" href="${pageContext.request.contextPath }/board_detail.do?boardNo=${list.boardNo}">${list.boardTitle }<c:forEach items="${replyCount}" var="rep">
	[${rep }]
	</c:forEach> </a>
