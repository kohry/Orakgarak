...
<div>
	...
	<table class="boardtable contentb">
		<tr>
			<td><c:out escapeXml="true" value="${board.boardContent }" />
  ...
  <div class="comment">
    ...
    <c:choose>
     ...
     <div class="content" id="boss"  align="left">
     	<c:if test="${not empty sessionScope.user.email && sessionScope.user.email == 'admin@orakgarak.com' || not empty sessionScope.user.email && sessionScope.user.name == list.replyWriter }">
      ...
      <div class="text">
        <span><c:out escapeXml="true" value="${list.replyContent}" /></span><br/>
